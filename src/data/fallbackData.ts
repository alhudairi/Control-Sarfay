...
export const FALLBACK_TELEMETRY_DATA: ApiResponse = {
  ...
  "pages": {
    ...
    "الصفحة الرئيسية": {
      ...
      "rows": [
        {"القطاع": "Zone 01", "الحالة": "مستقر / Stable", "آلية التشغيل": "محلي فقط / Local Operation Only", "مؤشر الصحة": "100%", "التاريخ": "2026/06/10", "ملاحظات": "يعمل بالنظام الموحد بكفاءة تامة"},
        {"القطاع": "Zone 02", "الحالة": "مستقر / Stable", "آلية التشغيل": "محلي فقط / Local Operation Only", "مؤشر الصحة": "100%", "التاريخ": "2026/06/10", "ملاحظات": "تغطية ممتازة ومؤشر الأداء مرتفع"},
        {"القطاع": "Zone 03", "الحالة": "مستقر / Stable", "آلية التشغيل": "محلي فقط / Local Operation Only", "مؤشر الصحة": "100%", "التاريخ": "2026/06/10", "ملاحظات": "ربط ميكانيكي وكهربائي كامل"},
        {"القطاع": "Zone (4,5,7,8)", "الحالة": "خارج الخدمة / Out of Service", "آلية التشغيل": "تشغيل قديم / Legacy Operating", "مؤشر الصحة": "0%", "التاريخ": "2026/06/10", "ملاحظات": "عدم رجوع الموحد بعد انقطاع كهربائي"},
        {"القطاع": "Zone 06", "الحالة": "مستقر / Stable", "آلية التشغيل": "محلي فقط / Local Operation Only", "مؤشر الصحة": "100%", "التاريخ": "2026/06/10", "ملاحظات": "ضخ مائي اعتيادي بدون انقطاع"},
        {"القطاع": "Zone 09", "الحالة": "مستقر / Stable", "آلية التشغيل": "محلي فقط / Local Operation Only", "مؤشر الصحة": "100%", "التاريخ": "2026/06/10", "ملاحظات": "اصلاح ناجح للجهاز رقم 2 الأسبوع الجاري"},
        {"القطاع": "Zone 10", "الحالة": "مستقر / Stable", "آلية التشغيل": "مراقبة وتحكم / Full Monitoring", "مؤشر الصحة": "100%", "التاريخ": "2026/06/10", "ملاحظات": "تكامل تام مع شاشات المراقبة بـ AVEVA"}
      ]
    }
  }
};
